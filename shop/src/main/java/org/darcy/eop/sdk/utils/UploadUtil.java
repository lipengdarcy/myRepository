package org.darcy.eop.sdk.utils;
...
import org.darcy.app.base.core.plugin.fdfs.FastdfsBundle;
...
public class UploadUtil {
	...
	/**
	 * 上传spring 的MultipartFile
	 * @param file spring 的MultipartFile
	 * @param subFolder 子文件夹
	 * @return
	 */
	public static String upload(MultipartFile file,String subFolder){
		/**
		 * 参数校验
		 */
		if(file==null  ){
	 ...
	 */
	public static String[] upload(MultipartFile file,String subFolder,int width,int height ){
