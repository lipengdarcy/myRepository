...
<script type="text/javascript">
	...
	var saveForm = function() {
		...
		$.ajax({
			url : url + 'regionprice/shipAdd.do',
			data : postData,
			type : 'post',
			dataType : 'json',
...
<body>
	<h2 class="contentTitle">区域运费-添加</h2>
	<div id="area_form_ctx" class="pageContent">
		<form id="area_form" method="post" action=""
			class="pageForm required-validate">
			<input type="hidden" id="product_id" name="pid"
				value="${product.pid }" /> <input type="hidden" id="region_id"
				name="regionId" value="" /> <input type="hidden" id="region_name"
			...
			<div class="pageFormContent nowrap" layoutH="97">
				<table>
					...
					<tr>
						...
						<td>
							...
							<div id="area1" class="cellCon">
								<div seled-name-show=".pshow-name-ele"
									cid="192224-212131-214785-0-0" min-layer="2" max-layer="5"
					...
					<tr>
						<th>起步价:&nbsp;</th>
						<td >						
							<input type="text" name="startship" value="0"/>
						</td>
					</tr>
					<tr>
						<th>门店自提</th>
					...
					<tr style="display: none;">
						<td colspan="2" >
							<span><input type="radio" name="effectnow" value="0" />将来生效</span>
							<span>生效时间：<input type="text" id="planeffecttime" name="planeffecttime" /></span> 
						</td>
					</tr>

					<tr>
						<td colspan="2" class="right-td"><span
							class="btn btn-default" onclick="saveForm();">提交</span></td>
					</tr>
				</table>
			</div>
		</form>
