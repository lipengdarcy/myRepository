...
<script type="text/javascript">
	...
	var saveForm= function(){
		...
		$.ajax({
			url: url+'regionprice/handAdd.do',
			data:postData,
			type:'post',
			dataType:'json',
		...
		<div class="pageFormContent nowrap" layoutH="97">
			<table>
				...
				<tr>
					<th>起步价:&nbsp;</th>
					<td >						
						<input type="text" name="starthand" value="0"/>
					</td>
				</tr>
				<tr>
					<th>价格区间:</th>
				...
				<tr>
					<td>&nbsp</td><td><span class="table-button add-price-table-row">+增加价格区间</span></td>
				</tr>
