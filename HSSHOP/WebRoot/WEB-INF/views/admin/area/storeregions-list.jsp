...
<form id="pagerForm" method="post" action="${ctx}/admin/area/storeregions.do">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li>
				<a class="icon" rel="page44" target="navTab" href="${ctx }/admin/area/storeregions.do" target="navTab" title="区域工厂/门店" ><span>刷新</span> </a>
			</li>
		</ul>
	</div>
...
<%-- 					<td>${s.address }</td>
					...
					<td width="120" align="center">
						<a title="编辑" target="navTab" href="${ctx }/admin/area.do?method=toSalerefregionsEdit&saleid=${s.id }&type=1" external="true" class="btnEdit" >编辑</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
