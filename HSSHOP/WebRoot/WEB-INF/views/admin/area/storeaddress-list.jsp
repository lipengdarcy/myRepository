...
<form id="pagerForm" method="post" action="${ctx}/admin/area/storeaddress.do">
	<input type="hidden" name="pageNum" value="1" /> 
	<input type="hidden" name="numPerPage" value="${numPerPage }" /> 
	<input type="hidden" name="type" value="1" /> <!-- 1代表门店 -->
</form>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li>
				<a class="add" href="${ctx }/admin/area.do?method=toSaleaddressAdd&type=1&title=添加门店" target="navTab" external="true" title="添加" ><span>区域门店-添加</span> </a>
			</li>
			<!--li>
			...
			<li>
				<a class="icon" rel="page44" target="navTab" href="${ctx }/admin/area/storeaddress.do" target="navTab" title="区域工厂/门店" ><span>刷新</span> </a>
			</li>
		</ul>
	</div>
...
<%-- 					<td width="70" align="center">${my:getSaleaddressType(s.type) }</td> --%>
					...
					<td width="120" align="center">
						<a title="编辑" target="navTab" href="${ctx }/admin/area.do?method=toSaleaddressEdit&saleid=${s.id }&type=1&title=区域门店编辑" external="true" class="btnEdit" >编辑</a>
