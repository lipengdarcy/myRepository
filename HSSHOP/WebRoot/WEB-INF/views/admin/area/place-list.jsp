...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li>
				<a class="add" href="${ctx }/admin/area.do?method=toPlaceAdd" target="navTab" external="true" title="添加" ><span>区域产地-添加</span> </a>
			</li>
			<li>
				<a class="icon" rel="page46" target="navTab" href="${ctx }/admin/area/place.do" target="navTab" title="区域品牌产地" ><span>刷新</span> </a>
			</li>
		</ul>
	</div>
			...
			<c:forEach var="s" items="${dataList}" varStatus="status">
				<tr id="tr_${s.id }" >
					...
					<a title="编辑" target="navTab"
						href="${ctx }/admin/area.do?method=toPlaceEdit&id=${s.id }"
