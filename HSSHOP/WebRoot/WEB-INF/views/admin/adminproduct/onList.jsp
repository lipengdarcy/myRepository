...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<%-- 			<li><a class="add"
				href="${ctx }/admin/adminproduct.do?method=toAdd&pageid=page11"
				target="navTab"><span>添加商品</span> </a></li> --%>
			<li><a class="add"
				href="${ctx }/admin/adminproduct.do?method=toAddSKU&pageid=page11"
			...
			<c:forEach var="props" items="${actionlist}" varStatus="status">
				<tr target="sid_user" rel="${props.pid}"
					...
					<td><a title="商品预览" target="_blank"
						...
						class="table-button"><span>图片</span></a> <a title="是否确定下架该产品"
						target="ajaxTodo"
						href="${ctx }/admin/adminproduct.do?method=changeProductState&state=1&pid=${props.pid }"
						class="table-button"><span>下架</span></a> <a title="编辑"
						target="navTab"
