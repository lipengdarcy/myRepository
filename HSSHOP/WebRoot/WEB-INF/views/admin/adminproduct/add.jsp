			...
			<div class="tabs">
				...
				<div class="tabsContent" style="height:300px">
					<div>
						...
						<dl>
							<dt>成本价</dt>
							<input type="text" name="product.costprice" value="0">
						</dl>
						<dl>
							<dt>市场价</dt>
							<input type="text" name="product.marketprice" value="0">
						</dl>
						<dl>
							<dt>本店价</dt>
							<input type="text" name="product.shopprice" value="0">
						</dl>
					</div>
					...
					<div>
						<dl>
							<dt>重量</dt>
							<input type="text" name="product.weight" value="0">
						...
						<dl>
							<dt>排序</dt>
							<input type="text" name="product.displayorder" value="0">
						</dl>
						<dl>
							<dt>库存数量</dt>
