...
<div class="pageContent">
				...
				<div class="tabsContent" style="height:300px">
					<div>
						...
						<dl  style="display:none;">
							...
							<input type="hidden" id="ProductId" name="product.pid" size="80" value="">
							<input type="hidden" name="product.skugid" size="80" value="">
						...
						<dl class="sel-cate-infor-content" attr-val-url="category.do?method=getCateAttrVals">
                            ...
                            <input type="hidden" productCateid name="product.cateid" value="${skuGroup.cateid }">
					...
					<div class="sku-infor-content" id="edit-sku-infor-content">没有规格信息</div>
					<div>
						<dl>
							<dt>重量</dt>
						...
						<dl>
							...
							<p>
	                            ...
	                            <label><input name="product.state" type="radio" value="1" checked="checked">否</label>
                            <br>
                        </p>
						</dl>
						<dl>
	...
	<script>
		loadCateAttrVals("${skuGroup.cateid }","#edit-sku-infor-content","category.do?method=getSKUCateAttrVals");

		initProSkuAttrs("${skuGroup.skugid }","#edit-sku-infor-content","adminproduct.do?method=getProSkuAttrList");
