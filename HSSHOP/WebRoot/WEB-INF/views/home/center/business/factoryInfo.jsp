...
<head>
	...
	<script type="text/javascript" src="${ctx }/themes/admin/xheditor/xheditor-1.2.1.min.js" ></script>
	<script type="text/javascript" src="${ctx }/themes/admin/xheditor/xheditor_lang/zh-cn.js"></script>
	...
	<div class="user-main">
		<div class="wrap clearfix">
			<div class="crumbs">
				...
				</strong>&gt; <a href="${ctx }dealproduct/salerIndexProList.do">工厂门户</a> &gt; <span>基础资料</span>
			</div>
			<div class="user-menu left">
				<%-- <c:import url="${ctx }/ucenter.do?navId=5" /> --%>
				...
				<div class="sales-data">
					<form id="factoryInfoForm" name="factoryInfoForm" action="">
						...
						<fieldset class="clearfix">
				           <legend>工厂名称：</legend>
							<input type="text" name="name" id="name" value="${store.name }"
								placeholder="请输入工厂名称" class="validate[required]"></input> <label class="red">*</label>
						</fieldset>
						<fieldset class="clearfix">
							<legend>联系人：</legend>
						...
						<fieldset class="clearfix">
				         ...
				         <fieldset class="clearfix">
				            <legend>详细地址：</legend>
				            <input type="text" name="address" id="address" value="${store.address }"  placeholder="请输入详细地址" class="validate[required]" />
						...
						<fieldset class="clearfix">
							<legend>工厂介绍：</legend>
							<textarea id="content" name="content">${store.content }
							</textarea>
						</fieldset>
