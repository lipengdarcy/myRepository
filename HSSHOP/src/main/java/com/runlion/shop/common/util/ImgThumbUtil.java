...
public class ImgThumbUtil {
	...
	public static void getThumbnail(String source, String output, int width,
			int height) {
	...
	private static void thumbnailHandler(String source, String output,
	...
	private static void BMPThumbnailHandler(String source, String output,
			int width, int height, boolean adjustSize) {
		try {
			File sourceFile = new File(source);
			if (sourceFile.exists()) {
	...
	public static void main(String[] agrs) {
		...
		getThumbnail("E:\\1.jpg", "E:\\test.jpg", 320, 320);
	}
