...
public class EncryptUtil {
	...
	public static String key = "aG9uZ3NoaWdyb3VwLmNvbQ==";

	/**
	 * <li>
	 * 方法名称:encrypt</li> 加密方法
	...
	/**
	 * <li>
	 * 方法名称:TripleDES_CBC_Encrypt</li> 功能描述: 经过封装的三重DES/CBC加密算法，如果包含中文，请注意编码。
	 * 
	 * @param sourceBuf
	 *            需要加密内容的字节数组。
	 * @param deskey
	...
	/**
	 * <li>
	 * 方法名称:DES_CBC_Encrypt</li> 功能描述: 经过封装的DES/CBC加密算法，如果包含中文，请注意编码。
	 * 
	 * @param sourceBuf
	 *            需要加密内容的字节数组。
	 * @param deskey
	...
	/**
	 * <li>
	 * 方法名称:DES_CBC_Decrypt</li> 功能描述: 经过封装的DES/CBC解密算法。
	 * 
	 * @param sourceBuf
	 *            需要解密内容的字节数组
	 * @param deskey
	...
	/**
	 * <li>
	 * 方法名称:MD5Hash</li> 功能描述: MD5，进行了简单的封装，以适用于加，解密字符串的校验。
	 * 
	 * @param buf
	 *            需要MD5加密字节数组。
	 * @param offset
	...
	/**
	 * <li>
	 * 方法名称:byte2hex</li> 功能描述: 字节数组转换为二行制表示
	 * 
	 * @param inStr
	 *            需要转换字节数组。
	 * @return 字节数组的二进制表示。
	...
	/**
	 * <li>
	 * 方法名称:addMD5</li> 功能描述: MD校验码 组合方法，前16位放MD5Hash码。
	 * 把MD5验证码byte[]，加密内容byte[]组合的方法。
	 * 
	 * @param md5Byte
	 *            加密内容的MD5Hash字节数组。
	 * @param bodyByte
	...
	public static void main(String[] args) throws Exception {
		String pass = EncryptUtil.encrypt("admin");
		System.out.println(pass);

		System.out.println(EncryptUtil.decrypt(pass));
	}
