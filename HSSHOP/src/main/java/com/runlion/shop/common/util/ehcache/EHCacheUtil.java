package com.runlion.shop.common.util.ehcache;
...
/**
 * @Description ehcache 缓存工具类 cacheName在ehcache.xml中配置
 * @author zhaowei
 * @date 2015/7/04 16:45:02
 * @version V1.0
 */
public class EHCacheUtil {
	...
	public static Cache initCache(String cacheName, long timeToLiveSeconds)
			throws Exception {
		return EHCacheUtil.initCache(cacheName,
				EHCacheConfig.MAXELEMENTSINMEMORY,
				EHCacheConfig.OVERFLOWTODISK, EHCacheConfig.ETERNAL,
				timeToLiveSeconds, EHCacheConfig.TIMETOIDLESECONDS);
	}
	...
	public static Cache initMyCache(String cacheName) throws Exception {
		return EHCacheUtil
				.initCache(cacheName, EHCacheConfig.TIMETOlIVESECONDS);
	}
