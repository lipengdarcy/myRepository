...
public class ImgMarkUtil {
	 ...
	 *            --y坐标
	 */
	public final static void pressImage(String pressImg, String srcImg,
			String targetImg, int posType, float alpha) {
		try {
			// 目标文件
	...
	public static void pressText(String pressText, String srcImg,
			String targetImg, String fontName, int fontStyle, Color color,
			int fontSize, int posType, float alpha) {
		try {
			File _file = new File(srcImg);
			Image src = ImageIO.read(_file);
			int wideth = src.getWidth(null);
	...
	public static void main(String[] args) {
		pressImage("E:/xhr.png", "E:/1.jpg", "E:/1_mark.jpg", 5, 0.3f);
		pressText("水印文字", "E:/1.jpg", "E:/1_text.jpg", "宋体", Font.PLAIN,
				Color.RED, 18, 5, 0.8f);
	}
}
